package com.my.base.features.ratelimit.domain;
...
public class TokenBucketDTO extends FrequencyControlDTO {
    ...
    public TokenBucketDTO(long capacity, double refillRate) {
        if (capacity <= 0 || refillRate <= 0) {
                throw new BusinessException(ResultCode.FORBIDDEN_ACCESS.getCode(),ResultCode.FORBIDDEN_ACCESS.getMessage());
        }
     ...
     * 获取令牌
     * @param permits
     * @return true-获取令牌失败 false-获取令牌成功
     */
